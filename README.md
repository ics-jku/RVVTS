...
The framework uncovered bugs in RVV implementations of [PULP Ara](https://github.com/pulp-platform/ara/) ([reports](https://github.com/ics-jku/RVVTS_RTL_AFC_Ara)), [Sail-RISC-V](https://github.com/riscv/sail-riscv) ([reports](https://github.com/ics-jku/RVVTS_SailRV_Spike)), [RISC-V VP++](https://github.com/ics-jku/riscv-vp-plusplus) and [QEMU](https://www.qemu.org/).
With its floating-point extension FP-RVVTS, RVVTS also uncovered bugs in RISC-V floating-point implementations; the corresponding results are available in the [FP-RVVTS repository](https://github.com/ics-jku/FP-RVVTS/tree/main).
